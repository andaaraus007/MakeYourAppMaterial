...
class ArticleDetailPagerAdapter extends FragmentStatePagerAdapter {
    private final ArticleDetailActivity articleDetailActivity;

    public ArticleDetailPagerAdapter(ArticleDetailActivity articleDetailActivity, FragmentManager fm) {
        super(fm);
